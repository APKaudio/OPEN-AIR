...
#
#
# Version 20250804.030000.0 (Original function moved here from utils_instrument_initialize.py)
# Version 20250804.031500.0 (Created as a standalone file to break circular imports.)
# Version 20250804.032200.0 (FIXED: Removed top-level import of console_log to resolve deeper circularity.)

current_version = "20250804.032200.0"
