...
#
#
# Version 20250801.1106.1 (Updated header and verified imports for new folder structure)

current_version = "20250801.1106.1" # this variable should always be defined below the header to make the debugging better
...
# Import CSV utility (still used for incremental saving of raw data) - CORRECTED PATH
from utils.utils_csv_writer import write_scan_data_to_csv

# Import frequency band definitions - CORRECTED PATH
