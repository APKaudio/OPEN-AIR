# tabs/TAB_EXPERIMENTS_PARENT.py
#
...
#
#
# Version 20250731.1 (Initial creation of the Experiments Parent Tab with nested child tabs.)

current_version = "20250731.1"
...
from tabs.tab_experiments_child_intermod import InterModTab # Renamed from tab_intermod.py
from tabs.tab_experiments_child_JSON_api import JsonApiTab # Renamed from tab_JSON_api.py
from utils.utils_instrument_control import debug_print


class TAB_EXPERIMENTS_PARENT(ttk.Frame):
    """
    A Tkinter Frame that serves as the parent tab for all Experiment-related functionalities.
    It contains a nested Notebook to organize child tabs like Intermod and JSON API.
    """
    def __init__(self, master=None, app_instance=None, console_print_func=None, **kwargs):
        """
        Initializes the TAB_EXPERIMENTS_PARENT.
        ...
        debug_print(f"🚫🐛 [DEBUG] Initialized TAB_EXPERIMENTS_PARENT. Version: {current_version}",
                    file=f"tabs/TAB_EXPERIMENTS_PARENT.py - {current_version}",
    ...
    def _on_tab_selected(self, event):
        """
        Function Description:
        Callback for when this TAB_EXPERIMENTS_PARENT tab is selected in the main parent notebook.
        ...
        current_file = f"tabs/TAB_EXPERIMENTS_PARENT.py - {current_version}"
        debug_print(f"🚫🐛 [DEBUG] TAB_EXPERIMENTS_PARENT selected. Version: {current_version}",
                    file=current_file,
