...
#
#
# Version 1.6 (Dropdown width increased, DWELL and Max Hold Time functionality swapped)

current_version = "1.6" # this variable should always be defined below the header to make the debuggin better
