...
def on_group_selected(zgd_frame_instance, group_name):
    ...
    if showtime_tab.selected_group == group_name:
        ...
        # I've moved this function to the shared file to prevent a circular import
        from tabs.Markers.showtime.zones_groups_devices.utils_display_showtime_shared import on_group_deselected
