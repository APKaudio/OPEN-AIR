...
#
#
# Version 20250801.2140.1 (Refactored debug_print to use debug_log and console_log.)

current_version = "20250801.2140.1" # this variable should always be defined below the header to make the debugging better
current_version_hash = 20250801 * 2140 * 1 # Example hash, adjust as needed
...
class TAB_MARKERS_PARENT(ttk.Frame):
    ...
    def __init__(self, master=None, app_instance=None, console_print_func=None, **kwargs):
        ...
        # Use console_log for general messages, pass it down
        ...
        debug_log(f"Initialized TAB_MARKERS_PARENT. Version: {current_version}",
                    file=__file__, # Use __file__ for the actual file path
    ...
    def _on_tab_selected(self, event):
        ...
        debug_log(f"TAB_MARKERS_PARENT selected.",
                    file=__file__,
                    version=current_version,
        ...
        if selected_child_tab_id:
            ...
            if hasattr(selected_child_tab_widget, '_on_tab_selected'):
                ...
                debug_log(f"Propagated _on_tab_selected to active child tab: {selected_child_tab_widget.winfo_class()}.",
                            file=__file__,
                            version=current_version,
                            function=current_function)
            else:
