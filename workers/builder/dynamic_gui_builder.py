...
class DynamicGuiBuilder(
    ...
    def _load_and_build_from_file(self):
        ...
        try:
            if self.json_filepath.exists():
                ...
                self._rebuild_gui()
                self.gui_built = True
                console_log(f"✅ Success! Loaded config: {self.json_filepath.name}")
            else:
                console_log(f"🟡 Warning: Config file missing at {self.json_filepath}")

        except Exception as e:
            console_log(f"❌ Error in _load_and_build_from_file: {e}")
    ...
    def _rebuild_gui(self):
        ...
        try:
            ...
            console_log(f"❌ Error in _rebuild_gui: {e}")
    ...
    def _create_dynamic_widgets(self, parent_frame, data, path_prefix=""):
        ...
        try:
            ...
            console_log(f"❌ Error in _create_dynamic_widgets: {e}")