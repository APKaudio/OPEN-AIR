...
try:
    ...
    print("Warning: 'workers.logger' not found. Using dummy logger for manager_visa_IP.")
...
def discover_ip_devices():
    ...
    my_ip = _get_local_ip()
    if my_ip == "127.0.0.1": 
        debug_logger("Could not determine local IP. Skipping network hunt.", **_get_log_args(), level="WARNING")
        return [], []
