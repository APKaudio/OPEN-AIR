# managers/manager_instrument_settings_amplitude.py
#
...
# A manager for amplitude-related settings.
#
...
class AmplitudeSettingsManager:
    ...
    def __init__(self, mqtt_controller: MqttControllerUtility):
        ...
        self.base_topic = "OPEN-AIR/configuration/instrument/amplitude"
        ...
        if Local_Debug_Enable:
            debug_log(
                message=f"🛠️🟢 Initializing AmplitudeSettingsManager and setting up subscriptions.",
                file=current_file,
