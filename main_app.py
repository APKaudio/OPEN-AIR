...
# NEW: Import MHZ_TO_HZ as it's needed for conversions (and should be part of app_instance)
...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        self.MHZ_TO_HZ = MHZ_TO_HZ # Make this accessible to other modules via app_instance
        ...
        # It needs to happen AFTER setup_tkinter_variables so that the variables exist
        # for configuration values to be loaded INTO them.
    ...
    def switch_tab(self, new_tab_name):
        ...
        for name, button in self.tab_buttons.items():
            ...
            if name == new_tab_name:
                ...
                # Call _on_parent_tab_selected on the new active tab
    ...
    def get_tab_instance(self, parent_tab_name, child_tab_name=None):
        ...
        Useful for one tab to interact with another.
        """
